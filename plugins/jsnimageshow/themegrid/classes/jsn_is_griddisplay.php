...
class JSNISGridDisplay extends JObject
{
	...
	function standardLayout($args)
	{
		...
		JHTML::stylesheet('prettyPhoto.css', $this->_assetsPath.'css/',array('media'=>'screen','charset'=>'utf-8'));
		$this->loadjQuery();
		JHTML::script('jsn_is_conflict.js',$this->_assetsPath.'js/');
		JHTML::script('jquery.kinetic.js', $this->_assetsPath.'js/jquery/');
		JHTML::script('jquery.masonry.min.js', $this->_assetsPath.'js/jquery/');
		JHTML::script('jquery.prettyPhoto.js', $this->_assetsPath.'js/jquery/');
		JHTML::script('jsn_is_gridtheme.js', $this->_assetsPath.'js/');
		JHTML::script('jsn_is_gridthemelightbox.js', $this->_assetsPath.'js/');
