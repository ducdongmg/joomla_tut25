...
class plgJSNImageshowThemeGrid extends JPlugin
{
	...
	function onLoadJSNShowcaseTheme($name, $themeID = 0)
	{
		...
		JHTML::stylesheet('admin_style.css', $this->_pathAssets.'css/');
		JHTML::script('jsn_is_admin_conflict.js',$this->_pathAssets.'js/');
		JHTML::script('jquery.kinetic.js', $this->_pathAssets.'js/jquery/');
		JHTML::script('jquery.masonry.min.js', $this->_pathAssets.'js/jquery/');
		JHTML::script('jsn_is_gridtheme.js', $this->_pathAssets.'js/');
